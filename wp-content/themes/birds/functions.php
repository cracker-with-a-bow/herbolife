...
function true_breadcrumbs(){
	...
	if( is_home() ){
			...
			echo '<a href="' . site_url() . '">Главная</a>' . $separator . '<a href="http://herbalife/blog/">Блог</a>'. $separator . $page_num . '-я страница';
		
 
	} else { // не главная
 
		echo '<a href="' . site_url() . '">Главная</a>' . $separator . '<a href="http://herbalife/blog/">Блог</a>'. $separator;
